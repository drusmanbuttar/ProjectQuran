...
assert 'CURRENT_PROJECT_VERSION = 18;' in (root/'ios/App/App.xcodeproj/project.pbxproj').read_text(), 'iOS build must be 18'
assert '"200013"' in (root/'android/app/build.gradle').read_text() and '"1.0.13"' in (root/'android/app/build.gradle').read_text(), 'Android beta version must be 1.0.13 / 200013'
