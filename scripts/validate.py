...
assert 'CURRENT_PROJECT_VERSION = 17;' in (root/'ios/App/App.xcodeproj/project.pbxproj').read_text(), 'iOS build must be 17'
assert '"200012"' in (root/'android/app/build.gradle').read_text() and '"1.0.12"' in (root/'android/app/build.gradle').read_text(), 'Android beta version must be 1.0.12 / 200012'
